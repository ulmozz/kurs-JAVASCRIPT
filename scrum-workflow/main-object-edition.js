...
let zespolDeweloperski = {
    ...
    powolajScrumMastera(osoba)
    {
        this.scrumMaster = osoba;

        console.log("Scrum Master:");
        console.log(this.scrumMaster);
    }
}
zespolDeweloperski.powolajScrumMastera("Gerard");

// Opcjonalnie:
// let kierownictwo = {
//     powolajScrumMastera(zespol, osoba)
//     {
//         zespol.powolajScrumMastera(osoba);

//         console.log("Scrum Master:");
//         console.log(zespol.scrumMaster);
//     }
// }
// kierownictwo.powolajScrumMastera(zespolDeweloperski, "Gerard");
...
let cel = "Zbudowanie nowej webowej aplikacji onboardingowej dla organizacji";

// Definiuje termin projektu
//
// Funkcja realizuje następujące wymaganie:
//
...
{
    console.log("Termin wdrożenia projektu:");
    console.log(termin);
}

let termin = "2023-01-31";

let termin1 = new Date();
let termin2 = new Date("2023-01-31");
let termin3 = new Date(2023, 1, 31);
let termin4 = new Date("2023/01/31");
...
function DefiniujBudzetProjektu(kwota, waluta)
{
    console.log("Budżet projektu:");
    console.log(kwota);
    console.log(waluta);
}
...
function PrzypiszZadanieDoBacklogu(zadanie, backlog, backlogStatus)
{
...
function DekomponujZadanie(zadanie)
{
    console.log("Dekomponuj zadanie:")
    console.log(zadanie);
}

// Wybierz metodę wytwórczą
//
// Funkcja realizuje następujące wymaganie:
//
...
// Sprawdza warunki zakończenia projektu
//
// Funkcja realizuje następujące wymaganie:
//
//
...
DefiniujBudzetProjektu(kwota, waluta);
...
console.log(koniecProjektu); // Spodziewam się false

// Przypadek, gdy Właściciel Peroduktu nie zgadza się na kontynuację
czyKontynuowac = false;
koniecProjektu = SprawdzWarunkiZakonczeniaProjektu(koniecProjektu, czyKontynuowac, dzis, termin, koszty, kwota, backlogStatus);
console.log("Czy koniec projektu?");
console.log(koniecProjektu); // Spodziewam się true